                            ...
                            <form action="{{ route('authenticate') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <input type="email" name="email" class="form-control input-lg rounded-top @error('email') is-invalid @enderror" id="email" aria-describedby="emailHelp" placeholder="Email" autofocus value="{{old('email')}}">
                                        @error('email')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-lg btn-success btn-block mb-4">Login</button>
